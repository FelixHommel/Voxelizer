...
{
    void operator()(GLFWwindow* window) { if(window != nullptr) glfwDestroyWindow(window); }
};
...
private:
    std::unique_ptr<GLFWwindow, ::GLFWwindowDeleter> m_window{ std::unique_ptr<GLFWwindow, ::GLFWwindowDeleter>(nullptr, {}) };
